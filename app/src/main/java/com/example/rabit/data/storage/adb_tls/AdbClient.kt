...
import com.example.rabit.data.storage.adb_tls.AdbProtocol.ADB_AUTH_RSAPUBLICKEY
import com.example.rabit.data.storage.adb_tls.AdbProtocol.ADB_AUTH_SIGNATURE
import com.example.rabit.data.storage.adb_tls.AdbProtocol.ADB_AUTH_TOKEN
import com.example.rabit.data.storage.adb_tls.AdbProtocol.A_AUTH
import com.example.rabit.data.storage.adb_tls.AdbProtocol.A_CLSE
import com.example.rabit.data.storage.adb_tls.AdbProtocol.A_CNXN
import com.example.rabit.data.storage.adb_tls.AdbProtocol.A_MAXDATA
import com.example.rabit.data.storage.adb_tls.AdbProtocol.A_OKAY
import com.example.rabit.data.storage.adb_tls.AdbProtocol.A_OPEN
import com.example.rabit.data.storage.adb_tls.AdbProtocol.A_STLS
import com.example.rabit.data.storage.adb_tls.AdbProtocol.A_STLS_VERSION
import com.example.rabit.data.storage.adb_tls.AdbProtocol.A_VERSION
import com.example.rabit.data.storage.adb_tls.AdbProtocol.A_WRTE
