...
class TrafficAnalyzerViewModel(
    ...
    private val analyzer = adbClient?.let { NeuralTrafficAnalyzer(it) }
    
    val packets = analyzer?.packets ?: MutableStateFlow(emptyList())
    val isHacked = analyzer?.isHacked ?: MutableStateFlow(null)
